 ...
 * 
 * @export
 * @interface InventoryOpenContainerResponse
 */
export interface InventoryOpenContainerResponse {
    /**
     * 
     * @type {InventoryGrantResults}
     * @memberof InventoryOpenContainerResponse
     */
...
/**
 * Check if a given object implements the InventoryOpenContainerResponse interface.
 */
export function instanceOfInventoryOpenContainerResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function InventoryOpenContainerResponseFromJSON(json: any): InventoryOpenContainerResponse {
    return InventoryOpenContainerResponseFromJSONTyped(json, false);
}

export function InventoryOpenContainerResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InventoryOpenContainerResponse {
...
export function InventoryOpenContainerResponseToJSON(value?: InventoryOpenContainerResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
